-- Step 2: padroniza financeiro oficial para considerar somente vendas pagas.
-- Mantemos total_sales/cancelled_sales como visão operacional, enquanto métricas financeiras
-- (gross/platform_fee/comissão) passam a usar exclusivamente status = 'pago'.
...
as $$
  ...
  grouped as (
    select
      ...
      -- Financeiro oficial: somente vendas pagas entram em receita consolidada.
...
as $$
  ...
  select
    ...
    -- Financeiro oficial: apenas pago.
