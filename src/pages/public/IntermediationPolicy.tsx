...
export default function IntermediationPolicy() {
  usePageMeta({
    title: "Política de Intermediação | SmartBus",
    description:
      "Entenda o papel do SmartBus como plataforma intermediadora de venda de passagens e a responsabilidade das empresas organizadoras.",
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            A SmartBus é uma plataforma digital de divulgação, gestão e venda de passagens para transportes vinculados a eventos. Nosso papel é intermediar a disponibilização das ofertas ao passageiro, conectando clientes às empresas organizadoras responsáveis por cada transporte anunciado na plataforma.
          </p>
        </div>
        ...
        <section className="space-y-4 rounded-lg border bg-card p-4 text-sm leading-relaxed">
          <div className="space-y-1">
            <h2 className="font-semibold">1. Papel da SmartBus</h2>
            <p>A SmartBus atua exclusivamente como intermediadora tecnológica e comercial da venda de passagens. A plataforma não realiza o transporte, não opera veículos, não define rotas, não executa embarques e não presta diretamente o serviço de transporte ao passageiro.</p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <p>A SmartBus disponibiliza na plataforma as informações fornecidas pela empresa organizadora, buscando facilitar a divulgação, a gestão e a venda das passagens. Eventuais atualizações operacionais, mudanças de logística, ajustes de horários ou decisões comerciais relacionadas ao transporte são de responsabilidade da empresa organizadora.</p>
          </div>

          <div className="space-y-1">
            <h2 className="font-semibold">5. Ciência do passageiro</h2>
            <p>Ao concluir a compra, o passageiro declara estar ciente de que a SmartBus atua apenas como plataforma intermediadora e de que a empresa organizadora identificada no evento é a responsável exclusiva pelo serviço de transporte contratado.</p>
          </div>
          ...
          <p className="pt-2 border-t text-muted-foreground">A SmartBus mantém seu compromisso com transparência, organização da jornada de compra e apoio tecnológico à comercialização das passagens, sem assumir a posição de transportadora ou executora do serviço ofertado.</p>
        </section>
