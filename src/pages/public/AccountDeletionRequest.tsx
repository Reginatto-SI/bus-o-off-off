...
export default function AccountDeletionRequest() {
  usePageMeta({
    ...
    description: "Saiba como solicitar manualmente a exclusão de conta e dados pessoais vinculados ao SmartBus.",
        ...
        <article className="space-y-8 rounded-xl border bg-card p-5 shadow-sm sm:p-8">
          <header className="space-y-3 border-b pb-6">
            ...
            <p className="max-w-3xl text-base leading-relaxed text-muted-foreground">
              Usuários do SmartBus podem solicitar a exclusão da conta e dos dados pessoais vinculados. As solicitações
              são analisadas individualmente para proteger a conta do usuário e preservar os registros que precisam ser
              mantidos por obrigações legais, financeiras ou de segurança.
            </p>
          </header>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Não envie senha, código de autenticação, dados completos de cartão, chaves de acesso ou documentos
              adicionais antes de uma solicitação específica da equipe.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              O SmartBus poderá solicitar informações adicionais para confirmar a identidade do solicitante e evitar
              exclusões indevidas, acessos não autorizados ou impactos em contas e empresas vinculadas.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              A solicitação será analisada e respondida dentro de prazo razoável, considerando a complexidade do pedido
          ...
          <section className="space-y-3">
            ...
            <p>
              O usuário receberá retorno pelo canal informado na solicitação. Quando a exclusão total não for possível,
              o SmartBus informará, de forma objetiva, quais registros precisam permanecer e por qual motivo geral.
            </p>
          </section>
