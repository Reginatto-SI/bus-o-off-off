...
const navigation = [
  { name: 'Eventos', href: '/admin/eventos', icon: Calendar, roles: ['gerente', 'operador', 'vendedor'] },
  { name: 'Frota', href: '/admin/frota', icon: Bus, roles: ['gerente', 'operador'] },
  { name: 'Motoristas', href: '/admin/motoristas', icon: Users, roles: ['gerente', 'operador'] },
  { name: 'Locais de Embarque', href: '/admin/locais', icon: MapPin, roles: ['gerente', 'operador'] },
  { name: 'Vendedores', href: '/admin/vendedores', icon: UserCheck, roles: ['gerente', 'operador'] },
  { name: 'Vendas', href: '/admin/vendas', icon: ShoppingCart, roles: ['gerente', 'operador'] },
  { name: 'Minhas Vendas', href: '/admin/minhas-vendas', icon: LinkIcon, roles: ['vendedor'] },
];
