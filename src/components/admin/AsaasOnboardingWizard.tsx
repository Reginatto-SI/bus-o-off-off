  ...
  const renderCreateStep3 = () => (
    <div className="space-y-4">
      ...
      <div className="space-y-2 rounded-lg border p-4 text-sm">
        ...
        <p className="flex items-start gap-2"><ShieldCheck className="mt-0.5 h-4 w-4 text-primary" />A senha <strong>não é criada</strong> dentro do SmartBus. Após a criação, o Asaas enviará um e-mail para <strong>{localCompanyData?.email}</strong> com o link para definir a senha de acesso.</p>
