...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      enforce_internal_log_retention: { Args: never; Returns: undefined }
      enqueue_email: {
      ...
      get_company_activation_report: {
        Args: never
        Returns: {
          asaas_account_id_production: string
          asaas_account_id_sandbox: string
          asaas_onboarding_complete_production: boolean
          asaas_onboarding_complete_sandbox: boolean
          asaas_pix_last_checked_at_production: string
          asaas_pix_last_checked_at_sandbox: string
          asaas_pix_ready_production: boolean
          asaas_pix_ready_sandbox: boolean
